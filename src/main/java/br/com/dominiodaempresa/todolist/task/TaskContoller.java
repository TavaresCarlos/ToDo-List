package br.com.dominiodaempresa.todolist.task;
...
import br.com.dominiodaempresa.todolist.controller.utils.Utils;
...
public class TaskContoller {
    ...
    public ResponseEntity create(@RequestBody TaskModel taskModel, HttpServletRequest request) {
        ...
        if(currentDate.isAfter(taskModel.getStartAt()) || currentDate.isAfter(taskModel.getEndAt())) {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("A data de início e término devem ser maior que a data atual.");
        }
